    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('menu-categories.index') }}" class="waves-effect">
                        <i class="ri-dashboard-line"></i>
                        <span>Menu Category</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('menu-products.index') }}" class="waves-effect">
                        <i class="ri-dashboard-line"></i>
                ...
                <li>
                    <a href="{{ route('contact-info.index') }}" class="waves-effect">
                        <i class="ri-gallery-line"></i>
                        <span>Contact Info</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('service-categories.index') }}" class="waves-effect">
                        <i class="ri-gallery-line"></i>
                        <span>Service Categories</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('service-products.index') }}" class="waves-effect">
                        <i class="ri-gallery-line"></i>
